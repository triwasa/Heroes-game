...
public class ArtilleryDecorator implements BattleObject {

    private final BattleObject decorated;
    private final DoubleDamagePercentChanceAttackStrategy attackStrategy;

    public ArtilleryDecorator(BattleObject aDecorated, int aPercentToDealDoubleDamage) {
        decorated = aDecorated;
        attackStrategy = new DoubleDamagePercentChanceAttackStrategy(aPercentToDealDoubleDamage);
