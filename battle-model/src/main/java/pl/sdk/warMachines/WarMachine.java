...
public class WarMachine {
    ...
    WarMachine(){
        stats = WarMachinesStatistic.TEST;
    }

    WarMachine(WarMachinesStatisticIf aStats){
        stats = aStats;
    ...
    int calculateDamage(WarMachine aAttacker, Creature aDefender) {
    ...
    static class Builder {
        ...
        Builder statistic (WarMachinesStatisticIf aStats){
            this.stats = aStats;
            return this;
        };
        ...
        WarMachine build(){
            ...
            WarMachine ret = createInstance(stats);
            if(amount == null){
                ret.amount=1;
            }
            else{
        ...
        WarMachine createInstance(WarMachinesStatisticIf aStats) {
            return new WarMachine(aStats);
        }
    }
    ...
    static class BuilderForTesting {
        ...
        WarMachine build(){
            ...
            WarMachinesStatisticIf stats = new WarMachineStatisticForTesting(name, attack, maxHp, moveRange, damage);
            WarMachine ret = createInstance(stats);
            if(amount == null){
                ret.amount=1;
            }
