...
enum WarMachinesStatistic implements WarMachinesStatisticIf{
    ...
    WarMachinesStatistic(String aName, int aAttack, int aMaxHp, int aMoveRange, Range<Integer> aDamage, String aDescription ) {
        name = aName;
        attack = aAttack;
        maxHp = aMaxHp;
