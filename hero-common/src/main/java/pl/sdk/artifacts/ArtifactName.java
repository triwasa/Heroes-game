...
public class ArtifactName {
    ...
    public final static String OGRES_CLUB_OF_HOVOC = "Ogre's Club of Havoc";
    public final static String SWORD_OF_HELLFIRE = "Sword of Hellfire";
    public final static String TITANS_GLADIUS = "Titan's Gladius";
    public final static String SHIELD_OF_THE_DWARVEN_LORDS = "Shield of the Dwards Lords";
    ...
    public final static String SHIELD_OF_THE_DAMNED = "Shield of the Damned";
    ...
    public final static String SCALES_OF_THE_GREATER_BASILISK = "Scales of the Greater Basilisk";
    public final static String TUNIC_OF_THE_CYCLOPS_KING = "Tunic of the Cyclops King";
    public final static String BREASTPLATE_OF_BRIMSTONE = "Breastplate of Brimstone";
    ...
    public final static String CROWN_OF_DRAGONTOOTH = "Crown of Dragontooth";
