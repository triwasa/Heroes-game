...
enum CreatureStatistic implements CreatureStatisticIf{
    ...
    DEAMON("Demon",10,10,35,5,Range.closed(7,9), 4, "Average unit for level 4, but the price is very reasonable.", "ground", false, "INFERNO"),
    HORNED_DEAMON("Horned Demon", 10,10,40,6, Range.closed(7,9), 4, "One of the smallest upgrades in the game: 5 hit points and 1 speed for 20 gold... reasonable, but horned demons are now below-average among level 4 upgrades, but their price still remains low.", "ground", true, "INFERNO"),
