...
//        Spell curseSpell = new Spell(SpellName.CURSE, 1);
//        Spell bloodLustSpell = new Spell(SpellName.BLOODLUST, 1);
//
//        Hero hero = convert(economyHero);
//
//        assertEquals( true, hero.getCreatures().get(0).getImmunity().checkImmunity(curseSpell));
//        assertNotEquals(true, hero.getCreatures().get(0).getImmunity().checkImmunity(bloodLustSpell));
    }
...
//        EconomyHero economyHero = new EconomyHero(DEATH_KNIGHT, NOT_IMPORTANT);
//        economyHero.addCreature(economyCreatureNecropolisFactory.create(false,1,1));
//        economyHero.addSpell(economySpellFactory.create(SpellName.BLESS, 1));
//
//        Hero hero = convert(economyHero);
//
...
//        economyHero.addSpell(economySpellFactory.create(SpellName.MAGIC_ARROW, 3));
//
//        Hero hero = convert(economyHero);
//
