...
//        hero.getCreatures().get(0).getAttackStrategy().attack(hero.getCreatures().get(0), hero2.getCreatures().get(0));
//
//        assertEquals(77, hero2.getCreatures().get(0).getCurrentHp());
    }
...
//        hero = convert(economyHero);
//
//        assertNotEquals(20 * 10 + 10 , hero.getSpells().get(0).getDamage());
//        assertEquals(20 * 10 + 30 , hero.getSpells().get(0).getDamage());
    }
}
